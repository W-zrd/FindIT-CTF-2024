...
return {
	...
	sql = { "SQL", "database" },
	ss = { "Scheme", "scheme" },
	svelte = { "Svelte", "flag_4" },
	svg = { "SVG", "markup" },
	swift = { "Swift", "swift" },
	tcl = { "Tcl", "tcl" },
	tex = { "LaTeX", "latex" },
	text = { "Text file", "text" },
	tf = { "Terraform", "flag_19" },
	tk = { "Tcl/Tk", "tcl" },
	tl = { "Teal", "teal" },
	toml = { "TOML", "toml" },
	ts = { "TypeScript", "typescript" },
	tsx = { "React", "react" },
	txt = { "Text file", "flag_14" },
